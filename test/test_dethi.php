                                ...
                                <form method="POST" action="your_action_page.php">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            <label class="text_row" id="totalEasyLabel">Số câu dễ có thể chọn: 0</label>
                                            <input type="number" class="form-control" name="socau_de"
                                                placeholder="Số câu dễ" min='0' max='0' required>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label class="text_row" id="totalMediumLabel">Số câu trung bình có thể chọn:
                                                0</label>
                                    ...
                                    <div id="questionCountDisplay" class="mt-3"></div>
