...
<head>
    ...
    .question-card.selected {
        ...
        /* Màu nền cho câu hỏi đã chọn đáp án */
    }
...
<body>
    ...
    <div class="container">
        ...
        if (count($questions) > 0) {
            ...
            foreach ($questions as $question) {
                ...
                $answerCount = $answers->num_rows;

                echo "<div class='question-card' id='question-$macauhoi'>";
                echo "<h5>Câu hỏi:</h5> <p>" . htmlspecialchars($questionData['noidung']) . "</p>";
                if ($answerCount > 1) {
                    echo "<span class='multi-answer-icon'>★</span>"; // Ký hiệu cho câu hỏi có nhiều hơn 1 đáp án
                }
    ...
    function updateSelectedAnswers(questionId) {
        ...
        questionElement.classList.toggle('selected', isAnyChecked);
    }

    // Đếm ngược thời gian
    let time = <?= $thoigianthi * 60 ?>; // Thời gian làm bài (tính bằng giây)
    ...
    const countdownInterval = setInterval(function() {
        ...
        if (time <= 0) {
            ...
            alert("Thời gian đã hết! Bài thi sẽ tự động nộp.");
